...
export const CATALOG: CatalogMember[] = [
  ...
  { slug: "sam-altman", name: "Sam Altman", aliases: ["Altman", "OpenAI"], role: "Co-founder & CEO, OpenAI", house: "OpenAI", initials: "SA" },
  { slug: "travis-kalanick", name: "Travis Kalanick", aliases: ["Kalanick", "Uber", "Atoms"], role: "Founder, Uber & Atoms", house: "Uber", initials: "TK" },
  { slug: "michael-ovitz", name: "Michael Ovitz", aliases: ["Ovitz", "CAA"], role: "Co-founder, CAA", house: "CAA", initials: "MO" },
  { slug: "micky-malka", name: "Micky Malka", aliases: ["Malka", "Ribbit"], role: "Founder, Ribbit Capital", house: "Ribbit", initials: "MM" },
  ...
  { slug: "jonathan-ross", name: "Jonathan Ross", aliases: ["Ross", "Groq"], role: "Founder, Groq", house: "Groq", initials: "JR" },
  { slug: "scott-wu", name: "Scott Wu", aliases: ["Wu", "Cognition"], role: "Co-founder & CEO, Cognition", house: "Cognition", initials: "SW" },
  { slug: "steve-stoute", name: "Steve Stoute", aliases: ["Stoute", "Translation"], role: "Founder & CEO, Translation", house: "Translation", initials: "SS" },
  { slug: "ed-catmull", name: "Ed Catmull", aliases: ["Catmull", "Pixar"], role: "Co-founder, Pixar", house: "Pixar", initials: "EC" },
  ...
  { slug: "rick-rubin", name: "Rick Rubin", aliases: ["Rubin"], role: "Producer, Def Jam / American Recordings", house: "Def Jam", initials: "RR" },
  ...
  { slug: "marc-andreessen", name: "Marc Andreessen", aliases: ["Andreessen", "a16z", "pmarca"], role: "Co-founder, a16z", house: "a16z", initials: "MA" },

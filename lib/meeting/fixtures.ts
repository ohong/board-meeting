...
export function fixtureDiscussion(): MeetingState {
  ...
  const transcript: TranscriptEntry[] = [
    ...
    { kind: "event", id: "ev2", event: "positions-ready", text: "All positions formed. Open discussion.", ts: t + 6000 },
    {
      ...
      text: "Kill it. 2.3% conversion with 38% of your support load is not a funnel, it is a subsidy for people who will never pay. Eighteen people cannot afford to run a charity with a login page.",
      addressedTo: "board",
      addressedName: null,
      intent: "statement",
      streaming: false,
    ...
    },
    {
      ...
      text: "David, the 34% is the number I would stare at, not the 2.3%. A third of your revenue walked in through a door you are about to brick up. The question is not free versus trial. It is what the free workspace is actually doing for you.",
  ...
  return {
    ...
    transcript: [
      ...
      { kind: "event", id: "ev3", event: "guest-joined", text: "Codex joined the meeting through WebMCP and took the guest seat.", ts: t },
      {
        ...
        speakerRole: "guest",
        speakerName: "Codex",
        text: "Context the board does not have: seven of our last ten enterprise wins first entered through a free workspace shared by an existing user. Those accounts now represent 22% of ARR.",
        addressedTo: "board",
        addressedName: null,
        intent: "context",
        streaming: false,
      ...
      },
      {
        ...
        speakerRole: "guest",
        speakerName: "Codex",
        text: "Does the enterprise-referral evidence change your view of the free tier?",
      ...
      { kind: "event", id: "ev4", event: "synthesis-requested", text: "Codex asked the secretary for a synthesis of the discussion so far.", ts: t + 4000 },
      {
        ...
        text: "Agreement: the current free tier is under-managed. Disagreement: whether to remove it (DHH) or redesign it as a referral channel (Daniel). Unresolved: the true payback of a free workspace once enterprise referrals are counted.",
        streaming: false,
        failed: false,
        ts: t + 5000,
      },
...
export const FIXTURE_READOUT: Readout = {
  ...
  tradeoffs: [
    "Support cost (38% of tickets) versus discovery (34% of paying customers, 22% of ARR via enterprise referrals)",
  ...
  nextActions: [
    "Instrument attribution for free-to-enterprise referrals before changing pricing",
  ...
  closingComments: [
    ...
    { memberId: "david-heinemeier-hansson", memberName: "David Heinemeier Hansson", text: "Stop paying for users who will never pay you.", fallback: false },
